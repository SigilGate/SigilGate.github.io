---
title: "Ротация gRPC-путей: защита трансграничного канала"
date: 2026-02-01T18:30:00+00:00
draft: false
summary: "Давно было в планах — и вот свершилось. Самый уязвимый участок сети теперь защищён автоматической ротацией адресов."
tags: ["безопасность", "маскировка", "xray", "grpc"]
---

Давно было в планах, и вот — наконец свершилось.

## Самый уязвимый участок
...
VLESS поверх gRPC — сильная комбинация. Трафик практически неотличим от обычного HTTPS: TLS с валидным сертификатом, HTTP/2, браузерный TLS-фингерпринт. Со стороны это выглядит как обращение к обычному веб-сервису.
...
Сейчас ротация настроена на каждый час. Практика покажет, приносит ли это ощутимые неудобства на клиенте. Если нет — интервал можно будет уменьшить.
