...
Управляющий кластер развернут. Данные [перебрались на новое место]({{< ref "blog/2026/04/20/новые-жильцы" >}}). API задеплоен и отвечает по HTTPS. Казалось бы — всё готово.
