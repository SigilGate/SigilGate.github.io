...
Знаменитая «горячая линия» между Москвой и Вашингтоном, установленная после Карибского кризиса, работала именно на одноразовых блокнотах вплоть до 1980-х — классический пример симметричного шифрования в действии. Советская разведка, однако, однажды допустила роковую ошибку: начала повторно использовать якобы одноразовые ключи. Американская контрразведка заметила это и в рамках операции VENONA на протяжении десятилетий расшифровывала переписку КГБ. Так были раскрыты десятки советских агентов — включая тех, кто передавал секреты атомной бомбы.
{{< /alert >}}
...
{{< alert icon="circle-info" >}}
В 2010 году Sony допустила в прошивке PlayStation 3 роковую ошибку: при каждой подписи использовалось одно и то же «случайное» число. С математической точки зрения это катастрофа — зная две подписи с одинаковым случайным числом, приватный ключ восстанавливается обычной алгеброй. Хакеры так и сделали. Пиратство на PS3 стало делом техники. Один предсказуемый байт — и вся криптографическая защита рассыпалась.
{{< /alert >}}
